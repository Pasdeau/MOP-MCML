...
/* Two-kernel PD-selective OP constants */
#define MAX_STEPS 60000    /* Max steps per photon (matches CPU sOut[60000]) */
#define MAX_PD_HITS 200000 /* Upper bound on PD-detected photons per run */
